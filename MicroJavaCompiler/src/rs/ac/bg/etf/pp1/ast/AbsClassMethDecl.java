...
public class AbsClassMethDecl extends AbstractOrRegularMethod {

    private AbstractMethodDecl AbstractMethodDecl;

    public AbsClassMethDecl (AbstractMethodDecl AbstractMethodDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AbsClassMethDecl(\n");
